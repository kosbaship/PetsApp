...
//                                      (103)
// (104) Go to activity_catalog.xml
// create this adapter then extend CursorAdapter and override the needed methods
// to bind the cursor that coming from the db with the views on the screen
/**
